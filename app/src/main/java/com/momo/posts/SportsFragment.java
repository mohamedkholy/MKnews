...
public class sports extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Call<articalsparent> call=apiInterface.getArticalssport(1,spp.getString("coun","US"));
        ...
        call.enqueue(new Callback<articalsparent>() {
            ...
            public void onResponse(Call<articalsparent> call, Response<articalsparent> response) {
                ...
                binding.sportsRecv.setAdapter(adapter);
            ...
            public void onFailure(Call<articalsparent> call, Throwable t) {
                ...
                binding.sportsRecv.setVisibility(View.GONE);
        ...
        binding.refresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                call.enqueue(new Callback<articalsparent>() {
                    @Override
                    public void onResponse(Call<articalsparent> call, Response<articalsparent> response) {
                        binding.sportsRecv.setVisibility(View.VISIBLE);
                        l=response.body().articles;
                         adapter=new LocalNewsAdapter(l,onArticleclick);
                        binding.sportsRecv.setAdapter(adapter);
        ...
        binding.sportsRecv.addOnScrollListener(new RecyclerView.OnScrollListener() {

            @Override
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                super.onScrolled(recyclerView, dx, dy);
                if(!binding.sportsRecv.canScrollVertically(1)){
                    ...
                    ApiInterface apiInterface=retrofit.create(ApiInterface.class);
                    if(page<=pages){
                        Call<articalsparent> call=apiInterface.getArticalssport(page,spp.getString("coun","US"));
                        page++;
                        call.enqueue(new Callback<articalsparent>() {
                            @Override
                            public void onResponse(Call<articalsparent> call, Response<articalsparent> response) {
